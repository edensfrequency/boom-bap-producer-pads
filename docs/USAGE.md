...
- [The toolbar](usage/toolbar-and-presets.md) — presets, undo/redo, Pad
  Quantize, Mono mode, metering, tabs
- **PADS tab**
  - [The pad grid & sample browser](usage/pad-grid-and-browser.md)
  - [Sample editor](usage/sample-editor.md) — waveform, zoom, trim, chop
  - [DSP controls & output routing](usage/dsp-controls.md) — filter,
    envelope, pitch, FX
  - [Step sequencer & Roll](usage/step-sequencer-and-roll.md)
- [STEMS tab](usage/stems-tab.md) — band/HPSS splitting, pre-mix levels,
  live preview
- [DISCOVER tab](usage/discover-tab.md) — local crate browser + YouTube
  Crate
